...
if __name__ == "__main__":
    ...
    def save_controller(signal_number=None, frame=None):
        print("\nSaving controller!")
        with open('models/Task1_DDPG_test10.pkl', 'wb') as file:
    ...
    robobo = RoboboEnv(env_type='randomized_simulation', robot_id='#0')  # 192.168.0.108
    train_controller(robobo, ddpg_controller, max_steps=500, episodes=10)
    save_controller()
